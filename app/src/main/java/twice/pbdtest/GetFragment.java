...
/**
 * Created by UX303L on 2/27/2017.
 */

public class GetFragment extends AppCompatActivity implements TabLayout.OnTabSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.ic_gem));
